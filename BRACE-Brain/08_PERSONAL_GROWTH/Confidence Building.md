...
---
    ...
    > [!info] Purpose
    > This note is a structured knowledge hub for **Confidence Building** inside the B.R.A.C.E brain.
    ...
    ## Active Questions
    - [ ] What do I need to understand next about Confidence Building?
