...
---
    ...
    > [!info] Purpose
    > This note is a structured knowledge hub for **Useful Code Snippets** inside the B.R.A.C.E brain.
    ...
    ## Active Questions
    - [ ] What do I need to understand next about Useful Code Snippets?
