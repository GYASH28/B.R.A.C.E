...
---
    ...
    > [!info] Purpose
    > This note is a structured knowledge hub for **CWIT Timetable** inside the B.R.A.C.E brain.
    ...
    ## Active Questions
    - [ ] What do I need to understand next about CWIT Timetable?
