...
---
    ...
    > [!info] Purpose
    > This note is a structured knowledge hub for **CWIT Personal Notes** inside the B.R.A.C.E brain.
    ...
    ## Active Questions
    - [ ] What do I need to understand next about CWIT Personal Notes?
